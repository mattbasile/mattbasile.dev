    ...
    <section className="mt-16 z-10">
      ...
      <div className="flex flex-wrap space-between mt-8 relative">
        <div className="mx-auto my-4 w-full md:w-1/3 text-center relative md:static">
          ...
          <button onClick={e=>props.selectModal(e)} title="BirthRide" className="bg-transparent hover:bg-blue-600 text-blue-600 font-semibold hover:text-white py-2 px-4 border border-blue-600 hover:border-transparent rounded">
          Learn More
          </button>
        ...
        <div className=" mx-auto my-4 w-full md:w-1/3 text-center relative md:static">
         ...
         <a className="block mx-auto w-4/5 " target="blank" href="https://donor-management-landing-page.netlify.com/">
          ...
          <button onClick={e=>props.selectModal(e)} title="Donor Management" className="bg-transparent hover:bg-blue-600 text-blue-600 font-semibold hover:text-white py-2 px-4 border border-blue-600 hover:border-transparent rounded">
          Learn More
          </button>
        ...
        <div className=" mx-auto my-4 w-full md:w-1/3 text-center relative md:static">
         ...
         <a className="block mx-auto w-4/5" target="blank" href="https://guidr2.netlify.com/">
          ...
          <button onClick={e=>props.selectModal(e)} title="Guidr" className="bg-transparent hover:bg-blue-600 text-blue-600 font-semibold hover:text-white py-2 px-4 border border-blue-600 hover:border-transparent rounded">
          Learn More
          </button>
