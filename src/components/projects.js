      ...
      <section className="mt-16 relative">
        ...
        <div className="flex flex-wrap space-between mt-8 ">
          <div className="mx-auto my-4 w-4/5 md:w-1/3 text-center ">
            ...
            <button onClick={e=>this.selectModal(e)} title="BirthRide" className="bg-transparent hover:bg-blue-600 text-blue-600 font-semibold hover:text-white py-2 px-4 border border-blue-600 hover:border-transparent rounded">
            Learn More
            </button>
          </div>
          <div className=" mx-auto my-4 w-4/5 md:w-1/3 text-center ">
           ...
           <a className="block mx-auto w-4/5 " target="blank" href="https://donor-management-landing-page.netlify.com/">
            ...
            <button onClick={e=>this.selectModal(e)} title="Donor Management" className="bg-transparent hover:bg-blue-600 text-blue-600 font-semibold hover:text-white py-2 px-4 border border-blue-600 hover:border-transparent rounded">
            Learn More
            </button>
          </div>
          <div className=" mx-auto my-4 w-4/5 md:w-1/3 text-center ">
           ...
           <a className="block mx-auto w-4/5" target="blank" href="https://guidr2.netlify.com/">
            ...
            <button onClick={e=>this.selectModal(e)} title="Guidr" className="bg-transparent hover:bg-blue-600 text-blue-600 font-semibold hover:text-white py-2 px-4 border border-blue-600 hover:border-transparent rounded">
            Learn More
            </button>
          </div>
        </div>
